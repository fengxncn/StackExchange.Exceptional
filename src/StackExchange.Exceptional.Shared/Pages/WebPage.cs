    ...
    string pageTitle) : HtmlBase
{
    ...
    /// </summary>
    public string HeaderTitle { get; set; } = "Exceptions Log: " + settings.Store.ApplicationName.HtmlEncode();
    /// <summary>
    /// The store we're rendering with this page.
    /// </summary>
    public ErrorStore Store { get; } = store;
    /// <summary>
    /// The base URL for requests to this page.
    /// </summary>
    private string BaseUrl { get; } = baseURL.EndsWith('/') ? baseURL : baseURL + "/";
    /// <summary>
    /// The current settings.
    /// </summary>
    public ExceptionalSettingsBase Settings { get; } = settings;
