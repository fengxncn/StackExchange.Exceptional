...
internal class IPNet
{
    ...
    /// </summary>
    private static readonly List<IPNet> ReservedPrivateRanges =
        [
            Parse("10.0.0.0/8"),
            Parse("172.16.0.0/12"),
...
#pragma warning disable RCS1194 // Implement exception constructors.
    public class IPNetParseException(string msg, params object[] format) : Exception(string.Format(msg, format))
    {
    }
