...
public class FactDiscoverer(IMessageSink diagnosticMessageSink) : Xunit.Sdk.FactDiscoverer(diagnosticMessageSink)
{
...
public class TheoryDiscoverer(IMessageSink diagnosticMessageSink) : Xunit.Sdk.TheoryDiscoverer(diagnosticMessageSink)
{
...
public class SkippableMessageBus(IMessageBus innerBus) : IMessageBus
{
