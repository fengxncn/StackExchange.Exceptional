...
public class Configuration(ITestOutputHelper output) : AspNetCoreTest(output)
{
    [Fact]
    ...
    private static string GetPath(string configFile) => Path.Combine("Configs", configFile);
}
